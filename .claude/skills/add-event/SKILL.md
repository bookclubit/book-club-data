...
4. Открытая встреча:
   ...
   ```
   - `topic_ids` — темы главы именно этой встречи. Нужно, когда главу делят на
     несколько эфиров (напр. «Часть 1» / «Часть 2»): каждый показывает только
     свои темы. Пусто/нет поля = вся глава (одна встреча на главу).
