...
- Мержи подряд Action выдерживает: прогоны идут по очереди, реестр собирается
  на свежем main, отклонённый пуш повторяется с пересборкой. Раньше пуш
  проигравшего прогона просто падал, и в сентябре 2026 реестр неделю ссылался
  на переименованный файл встречи. Если реестр всё же отстал — ручной запуск:
