...
events/
  closed-chapters/*.json          # закрытая встреча: книга, глава, pages{from,to}, notes_board_url
  live-talks/*.json               # открытая встреча: streams{youtube,vk}, talks[{title, speaker, avatar}], registration_url
media/
